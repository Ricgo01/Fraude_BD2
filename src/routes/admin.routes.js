...
router.get('/alertas/resueltas', controller.verAlertasResueltas)
router.get('/solicitud/:solicitudId/revisor', controller.verRevisorDeSolicitud)
router.get('/solicitudes', controller.verTodasLasSolicitudes)
router.get('/solicitudes/con-notas', controller.listarSolicitudesConNotas)
router.get('/solicitudes/estados', controller.contarSolicitudesPorEstado)
router.get('/dispositivos', controller.verDispositivos)
...
router.get('/lista/solicitudes/con-notas', controller.listarSolicitudesConNotas)
